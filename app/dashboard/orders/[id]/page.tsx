...
export default function OrderDetailPage() {
  ...
  if (!order) {
    return (
      <div className="text-center py-20">
        ...
        <Link href="/dashboard/orders" className="text-purple-400 mt-4 inline-block">Back to Orders</Link>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <Link href="/dashboard/orders" className="inline-flex items-center gap-2 text-gray-400 hover:text-white">
        ...
        <div className="flex justify-between">
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col items-center flex-1">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step.completed ? 'bg-gradient-to-r from-purple-500 to-pink-500' : 'bg-white/10'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-white">{new Date(order.eventDate).toLocaleDateString()}</span>
            </div>
            <div className="flex justify-between">
        ...
        <div className="p-6 rounded-2xl bg-white/5 border border-white/10">
          ...
          <p className="text-gray-400 text-sm mb-4">Contact us for any questions about your booking</p>
          <div className="space-y-3">
            <a href="tel:+8801234567890" className="flex items-center gap-3 text-gray-400 hover:text-white">
              <Phone size={18} /> +880 1234-567890
            </a>
            <a href="mailto:info@lbfilms.com" className="flex items-center gap-3 text-gray-400 hover:text-white">
