      ...
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl space-y-6">
        ...
        <div className="flex items-center gap-6">
          <div className="relative">
            <div className="w-24 h-24 rounded-full bg-linear-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white text-3xl font-bold">
              J
            </div>
            <button
              type="button"
              className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-purple-600 flex items-center justify-center text-white"
            >
              <Camera size={14} />
            </button>
          </div>
        ...
        <div className="flex gap-3">
          ...
          <Link href="/dashboard/profile">
            <button
              type="button"
              className="px-6 py-3 rounded-xl bg-white/5 text-gray-400 hover:text-white"
            >
              Cancel
            </button>
          </Link>
