    ...
    <main className="min-h-screen bg-black pt-24 pb-16">
              ...
              >
                <div className="relative aspect-video rounded-2xl overflow-hidden bg-gray-800">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="absolute top-1/2 cursor-pointer left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-linear-to-r from-purple-600 to-pink-600 flex items-center justify-center shadow-2xl opacity-90 group-hover:opacity-100 transition-opacity"
                  >
      ...
      {playingVideo && (
        ...
        >
          <button
            onClick={() => setPlayingVideo(null)}
            className="absolute top-4 right-4 z-50 cursor-pointer p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors"
          >
