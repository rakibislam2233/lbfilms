      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex gap-3">
              {[Facebook, Instagram, Youtube].map((Icon, idx) => (
                <motion.a
                  ...
                  className="w-12 h-12 rounded-xl bg-muted border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-muted transition-all"
                >
                  <Icon size={20} />
                </motion.a>
              ))}
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-3xl overflow-hidden border border-border h-full min-h-[400px]">
              <iframe
