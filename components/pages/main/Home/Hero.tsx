          ...
          >
            <Link href="/booking">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="relative px-8 py-3.5 cursor-pointer text-lg font-semibold text-white rounded-full overflow-hidden group"
              >
            ...
            <Link href="/gallery">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center cursor-pointer gap-2 px-8 py-3.5 text-lg font-semibold text-white rounded-full border border-white/30 bg-white/5 backdrop-blur-sm transition-all"
              >
