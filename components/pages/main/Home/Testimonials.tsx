      ...
      >
        ...
        <div className="max-w-3xl mx-auto relative">
          ...
          <button
            ...
            className="absolute left-0 md:-left-5 top-1/2  cursor-pointer -translate-y-1/2 p-3 rounded-full bg-white/10 border border-white/10 text-white hover:bg-white/20 transition-all"
          >
            <ChevronLeft size={24} />
          </button>
          <button
            onClick={nextTestimonial}
            className="absolute right-0 md:-right-5 top-1/2 cursor-pointer -translate-y-1/2 p-3 rounded-full bg-white/10 border border-white/10 text-white hover:bg-white/20 transition-all"
          >
