              ...
              {[
                ...
                return (
                  <a
                    key={index}
                    href={item.href}
                    className="flex items-center gap-4 p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group"
                  >
                    <div
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium text-lg group-hover:text-purple-400 transition-colors">
                        {item.value}
                      </p>
                    </div>
                  </a>
