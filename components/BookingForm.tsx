          ...
          >
            <div className="grid grid-cols-1 gap-4 md:gap-6 mb-6">
              <div className="relative">
                <label className="block text-secondary-700 font-medium mb-2 text-sm md:text-base">
                  Full Name *
                </label>
                <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="relative">
                  ...
                  <div className="relative">
                    <Calendar className="h-4 w-4 md:h-5 md:w-5 text-secondary-400 absolute left-3 top-3.5" />
                    <input
                      type="date"
                      name="eventDate"
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full pl-10 pr-4 py-2.5 md:py-3 border border-secondary-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent appearance-none text-sm md:text-base"
                    >
            ...
            <div className="bg-primary-50 p-3 md:p-4 rounded-lg mb-6">
              <p className="text-center text-secondary-700 font-medium text-sm md:text-base">
                Payment Method:{" "}
                <span className="pink-gradient-text font-bold">
                  Cash on Service
                </span>
              </p>
            </div>
